...
SECRET_KEY = 'django-insecure-igii9d#f8(mt*3b)3tl(aujy15tm4^-!^l86ml33^n!dn=oq&9'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'stockmanager',      # Nom de la base de données
        'USER': 'postgres',       # Utilisateur créé avant
